...
const projects = [
  {
    ...
    description: [
      'Admin Panel: Teachers/Moderators set up exams, provide learning materials, and evaluate student assessments.',
      'Student Access: Learners access learning materials, participate in exams, and track their progress.',
      'Integrated System: Facilitates seamless interaction between teachers and students for effective learning and assessment management.'
    ],
    ...
    image: 'https://placehold.co/600x400/1a1a1a/ffffff?text=LMS+Project'
  },
  {
    title: 'Check Me',
              ...
              <div className={`relative overflow-hidden rounded-xl ${
                ...
                <div className={`absolute inset-0 ${
                  isDarkMode 
                    ? 'bg-gray-900/60' 
                    : 'bg-white/60'
                } opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-6`}>
                  <a
